  ...
  <div class="max-w-screen-md mx-auto px-4 py-10">
    ...
    <div class="p-8 flex items-start bg-light-grey rounded md shadow-lg">
      ...
      <form @submit.prevent="createWorkout" class="flex flex-col gap-y-5 w-full">
        <h1 class="text-2xl tex-at-light-green">Record Workout</h1>
        ...
        <div class="flex flex-col">
          ...
          <select id="workout-type" class="p-2 text-gray-500 focus:outline-none" @change="workoutChange"
            v-model="workoutType">
        ...
        <div v-if="workoutType === 'strength'" class="flex flex-col gap-y-4">
          <div class="flex flex-col gap-x-6 gap-y-2 relative md:flex-row" v-for="(item, index) in exercises"
            ...
            <div class="flex flex-col md:w-1/3">
              ...
              <input type="text" required class="p-2 w-full text-gray-500 focus:outline-none" v-model="item.exercises">
            </div>
